...
class Window extends JFrame {
    ...
    private void initComponents(Window window) {
        ...
        jpJRBEncounter.add(new Box.Filler(new Dimension(50,0),
                                    new Dimension(50,0),
                                    new Dimension(50,0)));
        jpJRBEncounter.add(jrbRun);
        jpEncounter.add(jlblAction);
        jpEncounter.add(new Box.Filler(new Dimension(0,10),
                new Dimension(0,10),
                new Dimension(0,10)));
        ...
        jpJRBLoot.add(new Box.Filler(new Dimension(50,0),
                new Dimension(50,0),
                new Dimension(50,0)));
        jpJRBLoot.add(jrbNo);
        jpLoot.add(jlblEquip);
        jpLoot.add(new Box.Filler(new Dimension(0,10),
                new Dimension(0,10),
                new Dimension(0,10)));
    ...
    private class ButtonHeroEncounterListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (lootOption) {
                ...
                jlblStats.setText("<html>Name: " + hero.getName() + "<br>" +
    ...
    private class ButtonRunListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            LoggerHelper.print(hero.getName() + " arrived in a hostile environment!");
            gridLayout.setRows(map.getMapSize());
            gridLayout.setColumns(map.getMapSize());
            gridLayout.setHgap(-1);
            gridLayout.setVgap(-1);
    ...
    private class ButtonDeleteHeroListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            int dialogAnswer = JOptionPane.showConfirmDialog(Window.this, "Confirm deletion?","Deletion", dialogYesNo);
